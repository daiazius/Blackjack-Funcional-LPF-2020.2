if (typeof kotlin === 'undefined') {
  ...
  function darCartas() {
    ...
    if (p1.maoDoJogador.asNaMao) {
      jorje.innerHTML = jorje.innerHTML + ('\n' + '        <div id = ' + '"' + 'pontuacao' + '"' + '><p>Pontua\xE7\xE3o: ' + pont + ' ' + pontA + '<\/p><\/div>' + '\n' + '        ');
    } else {
  ...
  function manterMao() {
    ...
    var pontosJogador;
    if (p1.maoDoJogador.somarOTotal_za3lpa$(p1.maoDoJogador.cartasNaMao.size - 1 | 0) > p1.maoDoJogador.somarOTotalcomAs_za3lpa$(p1.maoDoJogador.cartasNaMao.size - 1 | 0)) {
  ...
  function verificinator() {
    ...
    if (p1.maoDoJogador.asNaMao) {
      if (p1.maoDoJogador.somarOTotalcomAs_za3lpa$(p1.maoDoJogador.cartasNaMao.size - 1 | 0) > 21) {
        ...
        tmp$_1 != null ? (tmp$_1.innerHTML = (tmp$_1 != null ? tmp$_1.innerHTML : null) + '<div id = "fimDeJogo" style = "background: green;">PARABENS OTARIO<\/div>') : null;
      ...
      tmp$_7 != null ? (tmp$_7.innerHTML = (tmp$_7 != null ? tmp$_7.innerHTML : null) + '<div id = "fimDeJogo" style = "background: green;">PARABENS OTARIO<\/div>') : null;
    }}
  function verificinatorDealer() {
    ...
    if (dealer.maoDoJogador.asNaMao) {
      if (dealer.maoDoJogador.somarOTotalcomAs_za3lpa$(dealer.maoDoJogador.cartasNaMao.size - 1 | 0) > 21) {
        ...
        jogoAcabou = true;
      } else if (dealer.maoDoJogador.somarOTotalcomAs_za3lpa$(dealer.maoDoJogador.cartasNaMao.size - 1 | 0) > p1.maoDoJogador.somarOTotal_za3lpa$(p1.maoDoJogador.cartasNaMao.size - 1 | 0)) {
        println('vencestes');
        (tmp$_2 = document.getElementById('pedir')) != null ? (tmp$_2.remove(), Unit) : null;
        (tmp$_3 = document.getElementById('manter')) != null ? (tmp$_3.remove(), Unit) : null;
        tmp$_4 = document.getElementById('jogo');
      ...
      jogoAcabou = true;
    } else if (dealer.maoDoJogador.somarOTotal_za3lpa$(dealer.maoDoJogador.cartasNaMao.size - 1 | 0) > p1.maoDoJogador.somarOTotal_za3lpa$(p1.maoDoJogador.cartasNaMao.size - 1 | 0)) {
      println('vencestes');
      ...
      jogoAcabou = true;
    } else if (dealer.maoDoJogador.somarOTotal_za3lpa$(dealer.maoDoJogador.cartasNaMao.size - 1 | 0) >= 17) {
      println('vencestes');
  ...
  _.verificinatorDealer = verificinatorDealer;
  _.Carta = Carta;
  _.Baralho = Baralho;
  _.Mao = Mao;
  _.Jogador = Jogador;
